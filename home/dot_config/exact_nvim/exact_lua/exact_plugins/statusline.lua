...
return {
  ...
  event = 'VeryLazy',
  dependencies = { 'echasnovski/mini.icons', 'catppuccin/nvim', 'folke/noice.nvim' },
  opts = function()
    return {
      options = {
        globalstatus = true,
      ...
      sections = {
        ...
        lualine_x = {
          ...
          {
            function()
              return UserConfig.icons.misc.debugger .. '  ' .. require('dap').status()
            end,
            cond = function()
