...
local zen = {
  ...
  on_open = UserUtil.zen.on_zen_open,
  on_close = UserUtil.zen.on_zen_close,
  show = {
    statusline = false,
    tabline = false,
  },
...
return {
  {
    ...
    keys = {
      ...
      {'<c-_>', function() Snacks.terminal(nil, terminal) end, desc = 'which_key_ignore'},
